...
<!-- BEGIN:curation-benchmark (generated by analysis/curation_figures.py) -->
## Validation — AI agents vs. manual curation

Pipeline 1 was benchmarked against manual curation across 16 disease scopes
(9 single-cell, 7 spatial).

| Metric | Value |
|---|---|
| Recall vs. manual curation | **90.5%** (182/201), 95% CI 85.7–93.9% |
| Expansion factor | **2.12×** (426 vs. 201 scope–paper assignments) |
| Additional candidates surfaced | 244 (unvalidated) |

![AI agents vs. manual curation](analysis/figures/fig1_venn.png)

The 244 AI-only papers have not been manually adjudicated, so **precision is not
